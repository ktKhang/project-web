...
@WebServlet("/user_thaoluan_thuongmaivamuaban")
public class user_thaoluan_thuongmaivamuaban extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public user_thaoluan_thuongmaivamuaban() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			RequestDispatcher rd= request.getRequestDispatcher("/WEB-INF/user_thaoluan_thuongmaimuaban.jsp");
