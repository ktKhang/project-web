	...
	<div class="container">
		...
		<!-- THÔNG TIN CÁ NHÂN -->
				    <div role="tabpanel" class="tab-pane fade active in Info_Content_text1" id="home-Vertical">
				     <form class="form-horizontal" id="form_validation" method="POST" novalidate="novalidate" action="UploadAvatarTeacher?IDupload=<%=acc.getAccount_id() %>" enctype="multipart/form-data">
		...
		<!-- ĐỔI MẬT KHẨU -->
				    <div role="tabpanel" class="tab-pane fade Info_Content_text3" id="messages-Vertical">
					    ...
					    <form name="frmDoiMK" action="Update_Password_Teacher" method="post">
					         <div class="row">
						            <div class="col-md-3 col-xs-4 col-xs-4 form-control-label">
						        ...
						        <button class="form_submit1" type="submit" onclick="return KiemTraPass()">Submit</button>	
					    </form>
					</div>
				    </div>
		<!-- KHÓA HỌC CỦA BẠN -->
				       ...
				       <sql:query dataSource="${dbsource}" var="result">
				           select *
				            ...
				            <tr style="display: table-row; cursor: pointer;">
				                ...
				                <td>
				                    <a class="button button-small list"  href="List_StudentCON?class_id=${row.class_id }&account_id=<%=acc.getAccount_id() %>" title="Edit">
